                ...
                <form>
                    <div class="form-field">
                        ...
                        <div class="input-field">
                            <input  placeholder="Write..."  type="text" value="" name="qa-keyword">
                        </div>
                    </div>
...
<!--                    <div class="form-field">-->
<!--                        <div class="input-title">--><?php //echo __('Order by','question-answer'); ?><!--</div>-->
<!--                        <div class="input-field">-->
...
<!--                    </div>-->
    ...
    <div class="nav-right">
        <div class="item notifications"><i class="fa fa-bars" aria-hidden="true"></i>
            ...
            <div class="notification-wrapper">
                ...
                <div class="notification-list-bottom">
                    <div class="load-notifications" pagenum="1"><?php echo __('Load more','question-answer'); ?></div>
                </div>
            </div>
